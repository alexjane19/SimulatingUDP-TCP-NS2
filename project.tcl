...
set fbw0 [open outbw0.tr w]
set fbw1 [open outbw1.tr w]
set fbw2 [open outbw2.tr w]
...
$ns duplex-link-op $r1 $n4 orient right
...
proc finish {} {
global f0 f1 f2 ns nf fbw0 fbw1 fbw2
$ns flush-trace
...
proc record {} {
global sink0 sink1 sink2 f0 f1 f2 fbw0 fbw1 fbw2
...
$ns at 0.5 "$exp0 start"
$ns at 1.0 "$exp1 start"
$ns at 1.5 "$exp2 start"
